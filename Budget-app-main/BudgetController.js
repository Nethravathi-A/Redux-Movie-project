...
var budgetController = (function() {
  ...
  return {
    ...
    calculateBudget: function() {
      ...
      //calculate the percentage of Balance
      balance= Math.round((((data.totals.inc)-(data.totals.exp))/ (data.totals.inc)) * 100);
      //console.log(balance) 
     alert(balance )
     if(balance>=50){
       alert("Super saver")
     ...
     alert("You have to watch on your expenses")
     }else{
       alert("Dont worry,A hungry stomach,An empty pocket teach you the best life lesson.")
     }
